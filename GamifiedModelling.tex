...
\begin{abstract} %FACP: I've tidied up the abstract... check it still says what you meant!
...
\end{abstract}
%FACP: my changes are in blue \textcolor{blue}{  }
...
%FACP: changed the following because it largely repeats the previous points
